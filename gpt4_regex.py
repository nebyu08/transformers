...
class RegexTokenizer(BaseTokenizer):
    ...
    def train(self,text,vocab_size,versbose=False):
        ...
        chunks=re.findall(self.pattern_compile,text)
        ...
        for i in range(num_embedding):
            ...
            for chunks_ids in ids:
                get_stats(ids=chunks_ids,counts=stats)
...
#intialize our class
text="once up on a time there was a mouse and 2342 rabit bank's"
vocab_size=312
gpt_4=RegexTokenizer() #initalze the tokenizer
gpt_4.train(text,vocab_size)
print("gpt's vocabs are: \n")
print(gpt_4.vocab)